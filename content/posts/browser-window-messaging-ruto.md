+++
title = "Messaging between Browser Windows using ruto.js"
description = "At my work I have to build solutions around communication between browser and iframe or a popup window. Here's how I solved it with ruto.js"
date = 2024-05-18
updated = 2024-05-18

[taxonomies]
tags = ["javascript", "browser", "library"]
...
1. The parent window sends a message to the child window
...
<script>
    ruto.receive(
        ...
        (response, message) => {
            ...
            return response.send("Hello from child");
        }
    );
</script>
```
