...
links = [
    { name = "GitHub", icon = "github", url = "https://github.com/rajnandan1" },
    { name = "Twitter", icon = "twitter", url = "https://twitter.com/_rajnandan_" },
    { name = "LinkedIn", icon = "linkedin", url = "https://www.linkedin.com/in/rajnandan1/" },
    { name = "Email", icon = "email", url = "mailto:rajnandan1@gmail.com" },
]
